...
public class LeaderList {
	...
	public static void topicSearch(String searchTerm) throws Exception{
		JSONObject result =  (JSONObject) topicGet(searchTerm,"people").get("property");
	...
	public static JSONObject topicGet(String query,String filter) throws Exception, IOException{
		...
		//System.out.println(root.get("property").toString());
		return root;
	}
